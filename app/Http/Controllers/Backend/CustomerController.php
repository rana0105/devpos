...
class CustomerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $location = '/home/devcornn/pos.devcorn.net/upload_file/resize_images/'. $filename;
     ...
     public function customerAdd(Request $request)
    {
        ...
        return redirect()->route('psales.create')->with(['success' => 'Customer have been successfully created !']);
    }
